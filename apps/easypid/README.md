...
This repository contains an implementation of a mobile EUDI wallet protoype.

This app was created by Animo Solutions in the context of the [SPRIN-D Funke ‘EUDI Wallet Prototypes’](https://www.sprind.org/en/challenges/eudi-wallet-prototypes/). It serves as a prototype for future wallet providers. For more information on the project reach out to ana@animo.id.
...
- [ISO/IEC TS 23220-3 - WD13](https://www.iso.org/standard/86783.html)
...
- [OAuth 2.0 Attestation-Based Client Authentication](https://datatracker.ietf.org/doc/html/draft-ietf-oauth-attestation-based-client-auth-01)
