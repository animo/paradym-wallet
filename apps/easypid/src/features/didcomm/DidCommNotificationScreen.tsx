...
import { type ResolveOutOfBandInvitationResultSuccess, parseDidCommInvitation } from '@package/agent'
...
import { resolveOutOfBandInvitation } from '@paradym/wallet-sdk/src/invitation/resolver'
