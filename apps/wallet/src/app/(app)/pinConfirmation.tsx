import { PidConfirmationScreen } from '@app/features/wallet/PidConfirmationScreen'
...
export default function Screen() {
  ...
  return <PidConfirmationScreen onSubmitPin={onSubmitPin} ref={inputRef} isLoading={isLoading} />
}
