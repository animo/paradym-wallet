...
export interface PidConfirmationScreenProps {
  onSubmitPin: (pin: string) => void
  isLoading: boolean
}

export const PidConfirmationScreen = forwardRef<PinDotsInputRef, PidConfirmationScreenProps>(
  ({ onSubmitPin, isLoading }: PidConfirmationScreenProps, ref) => {
    const { t } = useLingui()
