import { setWalletServiceProviderPin } from '@app/crypto/WalletServiceProviderClient'
import { useDevelopmentMode } from '@app/hooks'
import { useShouldUsePinForSubmission } from '@app/hooks/useShouldUsePinForPresentation'
...
import { OfflineSharingScreen } from './OfflineSharingScreen'
import type { OnPinSubmitProps } from './slides/PinSlide'

type MdocOfflineSharingScreenProps = {
  sessionTranscript: Uint8Array
  deviceRequest: Uint8Array
}

// Entry point for offline sharing with Mdoc
export function MdocOfflineSharingScreen({ sessionTranscript, deviceRequest }: MdocOfflineSharingScreenProps) {
