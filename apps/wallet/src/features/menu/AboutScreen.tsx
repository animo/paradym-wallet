import { useAppCopy } from '@app/config/copy'
      ...
      <YStack fg={1} px="$4" gap="$4">
        ...
        <YStack gap="$2" fg={1} jc="space-between">
          <InfoButton
            variant="view"
            title={t({
              id: 'aboutScreen.privacyPolicyTitle',
              message: 'Privacy Policy',
              comment: 'Label for button that opens the privacy policy',
            })}
            description={t({
              id: 'aboutScreen.privacyPolicyDescription',
