...
import { type DeferredCredential, storeDeferredCredential } from '@paradym/wallet-sdk/storage/deferredCredentialStore'
...
export type CompleteCredentialRetrievalOptions = {
  ...
  deferredCredential?: Omit<DeferredCredential, 'id' | 'createdAt' | 'lastCheckedAt'>
...
export const completeCredentialRetrieval = async (options: CompleteCredentialRetrievalOptions) => {
  ...
  await storeReceivedActivity(options.paradym, {
    ...
    // TODO(sdk): why is this stored like this? We already have it at the top
